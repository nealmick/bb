...
# Disclaimer:
Please be advised NBA Data Cloud is provided as an analytical tool and should be used as such. NBA Data Cloud is not responsible for the results or accuracy of the models generated by this tool. Historical performance and evaluations of the models does not guarantee future outcomes.  NBA Data Cloud is a supplementary tool for analysis and you must exercise your own judgment in evaluating future events. Users should independently assess and verify any information obtained from NBA Data Cloud before making decisions based on such information.

  
# Local Install is no longer supported. https://github.com/nealmick/bb/discussions/47:
