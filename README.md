...
Status: Got new score model integrated still going to be errors tonight when games start, i guaranteed it. all games will be deleted and and the server will be spazzing out for a bit. 
