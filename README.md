...
Status: Got scores and over under model working today(1-30).  Integrating new model with web app now.  I may end up deleting database to make this easier, geting rid of old model sigmoid predictions....
